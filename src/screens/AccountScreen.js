    ...
    <>
      <Box sx={{ flexGrow: 1, mt: 10}}>
        <Grid container spacing={2}>
          <Grid item xs={2}></Grid>
          <Grid item xs={4} sx={{ boxShadow:
              "0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)",border: "1px solid black"}} direction="row">
          ...
          <Grid item xs={4} sx={{ backgroundColor: "#82B6D9", boxShadow:
              "0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)",border: "1px solid black"}} direction="row">
            <Typography variant="h6" gutterBottom>
